...
const unsigned char CONFIG_PAGE_NAME[] = "8";
const unsigned char CLOCK_PAGE_NAME[] = "9";
...
const unsigned char TEMPERATURE_LABEL[] = "temp_val";
...
const unsigned char CLOCK_HOUR_LABEL[] = "hour_l";
const unsigned char CLOCK_MINUTE_LABEL[] = "min_l";
